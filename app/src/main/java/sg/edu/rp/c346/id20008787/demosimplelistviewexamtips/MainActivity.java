package sg.edu.rp.c346.id20008787.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray[0] = "Don't just read the code, code it as much as possible during each practicl session";
        ...
        ArrayAdapter adapter = new ArrayAdapter (this,
                android.R.layout.simple_list_item_1, Collections.singletonList(examTipsArray));
